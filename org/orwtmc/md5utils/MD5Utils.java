package org.orwtmc.md5utils.MD5Utils;
...
public class MD5Utils {
    ...
    public static void main(String[] args) {
        try {
            System.out.print("Master Key(length must be 8): ");
            Scanner mkey = new Scanner(System.in);
            String key = mkey.nextLine();// 自定义密钥
            MD5Utils mt= new MD5Utils(key, "utf-8");
            System.out.print("Raw Text：");
            Scanner rawtxt = new Scanner(System.in);
            String value = rawtxt.nextLine();// 明文
            System.out.println("Raw text: " + value);
            System.out.println("Encrypted text: " + mt.encode(value));
            System.out.println("MD5: "+ getMD5Value(value));
            System.out.println("=============================================================");
            System.out.print("Encrypted text: ");
            Scanner enstr = new Scanner(System.in);
            String enCodeStr = enstr.nextLine();// 密文
            System.out.println("Encrypted text: "+ enCodeStr);
            System.out.println("Raw text: " + mt.decode(enCodeStr));
     ...
     * @throws Exception
     */
    public MD5Utils(String deSkey, String charset) throws Exception {
